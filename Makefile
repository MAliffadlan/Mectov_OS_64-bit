...
OBJS64 = $(OBJ64_DIR)/boot64.o $(OBJ64_DIR)/kernel64.o \
         ...
         $(OBJ64_DIR)/k64_fd64.o $(OBJ64_DIR)/font8x16.o \
...
demos/fswrite64.mct: demos/fswrite64.c demos/sys64.h demos/entry.S scripts/build_mct64.py
	python3 scripts/build_mct64.py demos/fswrite64.c demos/fswrite64.mct 0x52000000
